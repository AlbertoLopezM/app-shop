                            ...
                            {{ csrf_field() }}
                                ...
                                <div class="content">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Nombre" name="username" value="{{ old('username') }}" required>
                                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input id="adress" type="text" placeholder="Dirección" class="form-control" name="adress" value="{{ old('adress') }}" required>
                                    </div>
